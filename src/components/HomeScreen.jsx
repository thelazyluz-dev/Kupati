...
const PARTICLES = [
  { e: '⭐', l: '7%',  t: '44%', s: 16, d: 0,   dur: 8,  rx: 12, ry: 8  },
  { e: '💵', l: '13%', t: '20%', s: 14, d: 1.4, dur: 10, rx: 18, ry: 10 },
  { e: '🌟', l: '19%', t: '72%', s: 12, d: 2.8, dur: 9,  rx: 15, ry: 6  },
  { e: '🪙', l: '4%',  t: '76%', s: 13, d: 0.6, dur: 11, rx: 10, ry: 14 },
  { e: '💎', l: '84%', t: '38%', s: 15, d: 0.3, dur: 8,  rx: 20, ry: 8  },
  { e: '🤑', l: '91%', t: '62%', s: 13, d: 2.0, dur: 12, rx: 8,  ry: 16 },
  { e: '💫', l: '78%', t: '76%', s: 11, d: 3.2, dur: 7,  rx: 14, ry: 10 },
  { e: '💰', l: '93%', t: '16%', s: 14, d: 1.8, dur: 9,  rx: 18, ry: 6  },
  { e: '✨', l: '30%', t: '7%',  s: 11, d: 1.6, dur: 11, rx: 12, ry: 12 },
  { e: '💸', l: '66%', t: '5%',  s: 11, d: 2.5, dur: 10, rx: 16, ry: 8  },
  { e: '⭐', l: '3%',  t: '30%', s: 10, d: 3.8, dur: 8,  rx: 10, ry: 18 },
  { e: '🪙', l: '96%', t: '38%', s: 10, d: 0.9, dur: 13, rx: 14, ry: 10 },
  { e: '💵', l: '50%', t: '10%', s: 12, d: 2.1, dur: 9,  rx: 22, ry: 7  },
  { e: '💎', l: '45%', t: '88%', s: 11, d: 3.5, dur: 11, rx: 16, ry: 12 },
  { e: '🌟', l: '72%', t: '55%', s: 13, d: 1.1, dur: 8,  rx: 10, ry: 16 },
  { e: '💰', l: '25%', t: '55%', s: 10, d: 4.2, dur: 12, rx: 18, ry: 8  },
]
      ...
      >
        ...
        {PARTICLES.map((p, i) => (
          <span key={i} className="absolute pointer-events-none select-none" style={{
            left: p.l, top: p.t, fontSize: p.s, opacity: 0.72,
